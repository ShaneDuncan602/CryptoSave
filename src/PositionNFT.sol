...
/**
 * @notice A dynamic NFT with a fully on-chain SVG to display position stats for the CryptoSave address owner.
 */

contract PositionNFT is ERC721, Ownable, CryptoSave {
