...
contract keeperNFT is ERC721, Owned 
{
    ...
    {
        ISimpleModel SimpleModel = ISimpleModel(0xC7Ee1dC6764C398881Db5843a74c8a58B277Bd01);
        ...
        parts[0] = string.concat("<svg viewBox='0 0 500 500' xmlns='http://www.w3.org/2000/svg'><path style='fill:#", SimpleModel.isInMoney() ? "16cb19" : "cb1616"); // BG_GREEN : BG_RED

        parts[1] = "' d='M0 0h500v500H0z'/>";

        parts[2] = string.concat(SimpleModel.isInMoney() ? EMOJI_SMILE : EMOJI_POO, SimpleModel.isInMoney() ? ARROW_LEFT_UP : ARROW_LEFT_DOWN);

        parts[3] = string.concat("<text style='fill:#dbfad4;font-family:Arial,sans-serif;font-size:64.6px;font-weight:700;stroke:#cceb68;white-space:pre' transform='matrix(.51199 0 0 .5273 -46.467 211.966)' x='211.757' y='466.61'>", SimpleModel.strLifetimePercent());
